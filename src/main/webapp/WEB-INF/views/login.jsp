...
.form::before {
	...
	right: 1%;
	z-index: -1;
	background: radial-gradient(circle, rgb(194, 13, 170) 20%,
		rgb(26, 186, 235) 60%, rgb(26, 186, 235) 100%);
	filter: blur(70px);
	border-radius: 50%;
}
...
.container::after {
	...
	background: radial-gradient(circle, rgba(157, 173, 203, 1) 61%,
...
.input {
	box-shadow: inset 4px 4px 4px rgba(165, 163, 163, 0.315), 4px 4px 4px
		rgba(218, 218, 218, 0.13);
}
</style>
			...
			<div class="left">
				<form class="form" action="userlogin" method="post">
					...
					<c:if test="${not empty error }">
						<p class="text-center text-danger fw-bold">${error }</>
						<c:remove var="error" />
					</c:if>
				</form>
			</div>
			<div class="right">
				<div class="img">
                    ...
                    <polygon
							...
							fill="#a0616a"></polygon>
                    <circle cx="465.32321" cy="55.18079" r="41.33858"
							fill="#a0616a"></circle>
                    <polygon
