...
<body class="image">
	...
	<a href="teacher_panel" class="ms-5" style="cursor: pointer;"><i class="fa-solid fa-arrow-left fa-3x text-white mt-4"></i></a>

	<div class="abc">
		<section class="container">
			<header>Add Teacher Form</header>

			<c:if test="${not empty addMsg }">
				<div class="text-center">
					<h5 class=" text-success">${addMsg }</h5>
					<a href="chechDetail" style="color: #ee4e34">Check Here</a>
				</div>
				<c:remove var="addMsg" />
			</c:if>
			...
			<form class="form" action="add" method="post">
				...
				<div class="input-box address">
					...
					<div class="column">
						...
						<input required="required" name="city" placeholder="Enter your city"
							type="text">
					</div>
				</div>
